...
Garbage.JobPayout = 36 -- Amount to get paid per bag grabbed. Divided evenly amoung the group

Garbage.BuffsEnabled = false -- True or False to enable the liberty buff system on payout.
